(function () {
  ...
  const zh = {
    ...
    'message.editQuestion': '编辑当前问题', 'message.sendEdited': '发送（Enter）', 'message.emptyEdit': '问题内容不能为空',
  ...
  const translations = {
    ...
    en: {
      ...
      'message.editQuestion': 'Edit this question', 'message.sendEdited': 'Send (Enter)', 'message.emptyEdit': 'The question cannot be empty.',
    ...
    id: {
      ...
      'message.editQuestion': 'Edit pertanyaan ini', 'message.sendEdited': 'Kirim (Enter)', 'message.emptyEdit': 'Pertanyaan tidak boleh kosong.',
    ...
    ar: {
      ...
      'message.editQuestion': 'تعديل هذا السؤال', 'message.sendEdited': 'إرسال (Enter)', 'message.emptyEdit': 'لا يمكن أن يكون السؤال فارغاً.',
    ...
    pt: {
      ...
      'message.editQuestion': 'Editar esta pergunta', 'message.sendEdited': 'Enviar (Enter)', 'message.emptyEdit': 'A pergunta não pode estar vazia.',
